...
#### Common Normalized Score
```{r}
ajive_cortisol_working$joint_scores
```

#### Cortisol joint loadings
```{r}
ajive_cortisol_working$block_decomps[[1]]$joint$v
```

#### Working Memory joint loadings
```{r}
ajive_cortisol_working$block_decomps[[2]]$joint$v
```
...
#### Common Normalized Score
```{r}
ajive_cortisol_fmri_demographics$joint_scores
```

#### Cortisol joint loadings
```{r}
ajive_cortisol_fmri_demographics$block_decomps[[1]]$joint$v
```

#### fMRI joint loadings
```{r}
ajive_cortisol_fmri_demographics$block_decomps[[2]]$joint$v
```


#### Demographics joint loadings
```{r}
ajive_cortisol_fmri_demographics$block_decomps[[3]]$joint$v
```
...
#### Common Normalized Score
```{r}
ajive_cortisol_working_demographics$joint_scores
```

#### Cortisol joint loadings
```{r}
ajive_cortisol_working_demographics$block_decomps[[1]]$joint$v
```

#### Working Memory joint loadings
```{r}
ajive_cortisol_working_demographics$block_decomps[[2]]$joint$v
```


#### Demographics joint loadings
```{r}
ajive_cortisol_working_demographics$block_decomps[[3]]$joint$v
```
